...
try:
    ...
    insert_photometric_query = """INSERT INTO celestial_photometric_data (obj_ID, u, g, r, i, z)
                                  VALUES (%s, %s, %s, %s, %s, %s);"""
    ...
    insert_spectroscopic_query = """INSERT INTO celestial_spectroscopic_data (spec_obj_ID, obj_ID, plate, MJD, fiber_ID)
                                    VALUES (%s, %s, %s, %s, %s);"""
